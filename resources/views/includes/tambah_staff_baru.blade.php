<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Staff Administrasi dan Laboratorium</h1>
</div>
<div class="row">
    <div class="col">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Staff Administrasi dan Laboratorium</h6>
            </div>
            <div class="card-body">
                <form action="/tambah_staff_baru_action" method="POST" enctype="multipart/form-data">
                    @csrf
